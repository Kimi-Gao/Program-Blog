...
![image](http://oqos7hrvp.bkt.clouddn.com/blog/continuous-integration.png)
...
在`Slack`的App里面搜索 Travis 后点击 VIEW 进入

![image](http://oqos7hrvp.bkt.clouddn.com/blog/slack-add-app-travisci.png)

点击 Install，然后再点击 Add Travis Integration，即可对 Travis 集成进行授权。

![image](http://oqos7hrvp.bkt.clouddn.com/blog/slack-travis-add.png)

![image](http://oqos7hrvp.bkt.clouddn.com/blog/slack-travis-add-auth-00.png)

![image](http://oqos7hrvp.bkt.clouddn.com/blog/slack-travis-add-auth-01.png)
...
![image](http://oqos7hrvp.bkt.clouddn.com/blog/travis-01.png)

![image](http://oqos7hrvp.bkt.clouddn.com/blog/travis-02.png)

与此同时它也会把构建结果同步到你的 Slack channel 上。

![image](http://oqos7hrvp.bkt.clouddn.com/blog/slack-notification-info.png)
...
1. [how-to-use-travis-ci](https://github.com/nukc/how-to-use-travis-ci)
1. [一步一步教你用 GitHub+Slack+TravisCI 构建 Go 的自动化持续集成](http://maiyang.me/2017/12/04/github-slack-travis-ci/)